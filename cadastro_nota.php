...
<body>
   ...
   <form action="" method="POST"> 
        <h1><b>Destinatario</b></h1>
      <div class="form-group">
        <p>
     <label for="destina_camp">DESTINATARIO</label>
     <input type="text" class="form-control" name="remet" placeholder="Destinatario">
        </p>
     </div>  
      <div class="form-group">
        <p>
          ...
          <div class="form-group">
            ...
            <label for="cep">Cep</label>
             <input type="text" class="form-control" name="cepcity" placeholder="Exp: 0000-0000">
               ...
               <p> 
            <input type="submit" name="submit" value="CADASTRO NOTA" >
          </p> 
